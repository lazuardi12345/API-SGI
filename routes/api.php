...
Route::middleware(['auth:sanctum', 'role:hm'])->group(function () {
    ...
    Route::post('brankas/validasi/{id}', [BrankasController::class, 'validasiSetoran']);
...
Route::middleware(['auth:sanctum', 'role:checker'])->group(function () {
    ...
    Route::get('admin/harian/cetak-serah-terima', [LaporanHarianCheckerController::class, 'cetakLaporanSerahTerima']);
